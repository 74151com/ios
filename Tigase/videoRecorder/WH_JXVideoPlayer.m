...
//        self.parent = value;
        self.isPlaying = NO;
        // 添加上下两个地方的透明模板
        _topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, JX_SCREEN_WIDTH, THE_DEVICE_HAVE_HEAD ? 88 : 64)];
...
- (void)start{
    ...
    UIImageView *imgV = [[UIImageView alloc] initWithFrame:CGRectMake(25, 34, 16, 16)];
