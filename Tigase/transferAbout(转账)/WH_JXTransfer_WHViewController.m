...
- (void)WH_didVerifyPay:(NSString *)sender {
   ...
   [g_server WH_transferToPeopleWithUserId:_wh_user.userId roomId:_roomId money:_countTextField.text remark:_replayTextField.text time:time secret:secret toView:self];
}
