    ...
    for (NSInteger k = 0; k< page; k++) {
        ...
        for (NSInteger i = k*8; i < dataArr.count; i++)
        {
            ...
            if (type) {
                ...
                } else if ([checkNull(tempDic[@"url"]) isEqualToString:@"shaizi2"]) {
                    imageView.image = [UIImage imageNamed:@"shaizi2"];
                    
                } else if ([checkNull(tempDic[@"url"]) isEqualToString:@"jsbcaiquan"]) {
                    imageView.image = [UIImage imageNamed:@"jsbcaiquan"];
...
//        [myEmotArr insertObject:@{@"url":@"jsbcaiquan"} atIndex:0];
//        [myEmotArr insertObject:@{@"url":@"shaizi2"} atIndex:0];
//        [myEmotArr insertObject:@{@"url":@"first_jian"} atIndex:0];
