...
//    }else {
    ...
    if (self.msg.isMySend) {
        ...
        _messageConent.textColor = HEXCOLOR(0x3A404C);  [UIColor purpleColor];//
    }
//    if (self.msg.isGroup){
//        memberData *roleData = [self.room getMember:self.msg.fromUserId];
//        NSLog(@"roleData.vip = %d",[roleData.vip intValue]);
//        if ([roleData.vip integerValue] == 1)  {
//            _messageConent.textColor =  [UIColor redColor];//  HEXCOLOR(0x4776C6);
//        }else if ([roleData.vip integerValue] == 2)  {
//            _messageConent.textColor =   [UIColor greenColor];
//
//        }else if ([roleData.vip integerValue] == 3)  {
//            _messageConent.textColor =    [UIColor blueColor];//  THEMECOLOR;
//        }
//    }
...
+ (float)getChatCellHeight:(WH_JXMessageObject *)msg {
    if ([msg.chatMsgHeight floatValue] > 1 && ![msg.fileName isEqualToString:@"950"]) {
