...
enum kWCMessageType {
    ...
    kWCMessageTypeTalkOnline = 1211, //取消轮麦
    kWCMessageTypeTalkJoin = 1212, //取消轮麦
    kWCMessageTypeTalkQuit = 1213, //取消轮麦
    ...
    kWCMessageTypeWithEdit = 950, // 编辑消息
    kWCMessageTypeWithEditWithServer = 951, // 消息服务端主动编辑
