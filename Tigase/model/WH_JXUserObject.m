...
//    user.userType = [NSNumber numberWithInt:2];
//    user.roomFlag = [NSNumber numberWithInt:0];
//    user.content = Localized(@"JX_PaymentNo.");;
//    user.timeSend = [NSDate date];
//    user.chatRecordTimeOut = g_myself.chatRecordTimeOut;
//    if(!user.haveTheUser)
//        [user insert];
...
//        [self userFromDataset:rs];
        if([user.userNickname containsString:@"我的Android"]||[user.userNickname containsString:@"我的Windows电脑"]||[user.userNickname containsString:@"新的朋友"]||[user.userNickname containsString:@"我的Mac电脑"]||[user.userNickname containsString:@"我的Web网页"]){}else{
...
//    self.longitude = [dict objectForKey:@"longitude"];
    ...
    self.serInviteCode = [dict objectForKey:@"serInviteCode"];
