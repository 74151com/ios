...
- (void)getDataWithDict:(NSDictionary *)dict {
    ...
    //self.isOpenRegister = @"1";
    if ([p objectForKey:@"nodesInfoList"]) {
        self.nodesInfoList = [p objectForKey:@"nodesInfoList"];
    }
    if ([p objectForKey:@"androidAppUrl"]) {
        self.androidAppUrl = [p objectForKey:@"androidAppUrl"];
    }
...
//        configuration.appID = @"1259280364";
    ...
    if ([p objectForKey:@"exchangeVipScore"]) {
        self.exchangeVipScore = [p objectForKey:@"exchangeVipScore"] ;
    }
...
- (NSString *)getConfigDefault:(NSString *)url {
    NSString* defApiUrl = @"http://api.jiagongchang.cc:8092/config";
    NSString* defCfgStr = @"{\"currentTime\":1615479996498,\"data\":{\"PCXMPPDomain\":\"api.jiagongchang.cc\",\"PCXMPPHost\":\"api.jiagongchang.cc\",\"XMPPDomain\":\"im.jiagongchang.cc\",\"XMPPHost\":\"im.jiagongchang.cc\",\"XMPPTimeout\":180,\"address\":\"CN\",\"aliLoginStatus\":2,\"aliPayStatus\":2,\"aliWithdrawStatus\":2,\"androidAppUrl\":\"\",\"androidDisable\":\"\",\"androidExplain\":\"\",\"androidVersion\":0,\"apiUrl\":\"http://api.jiagongchang.cc/\",\"appleId\":\"\",\"audioLen\":\"20\",\"chatRecordTimeOut\":-1,\"copyrightInfo\":\"\",\"cusServerUrl\":\"\",\"displayRedPacket\":1,\"distance\":20,\"downloadAvatarUrl\":\"http://file.jiagongchang.cc/\",\"downloadUrl\":\"http://file.jiagongchang.cc/\",\"fileValidTime\":-1,\"guideWebsite\":\"\",\"headBackgroundImg\":\"\",\"helpUrl\":\"\",\"hideSearchByFriends\":1,\"hmPayStatus\":2,\"hmWithdrawStatus\":2,\"invisibleList\":[],\"iosAppUrl\":\"\",\"iosDisable\":\"\",\"iosExplain\":\"\",\"iosVersion\":0,\"ipAddress\":\"121.127.241.20\",\"isAudioStatus\":0,\"isCommonCreateGroup\":0,\"isCommonFindFriends\":0,\"isDelAfterReading\":0,\"isDiscoverStatus\":1,\"isEnableCusServer\":1,\"isNodesStatus\":0,\"isOpenCluster\":0,\"isOpenDHRecharge\":1,\"isOpenGoogleFCM\":0,\"isOpenOSStatus\":0,\"isOpenPositionService\":1,\"isOpenReadReceipt\":1,\"isOpenReceipt\":1,\"isOpenRegister\":1,\"isOpenSMSCode\":1,\"isOpenTelnum\":1,\"isOpenTwoBarCode\":1,\"isQestionOpen\":0,\"isTabBarStatus\":1,\"isUserSignRedPacket\":0,\"isWeiBaoStatus\":0,\"isWithdrawToAdmin\":0,\"jiGuangStatus\":2,\"jitsiServer\":\"\",\"liveUrl\":\"\",\"macAppUrl\":\"\",\"macDisable\":\"\",\"macExplain\":\"\",\"macVersion\":0,\"maxSendRedPagesAmount\":500,\"minTransferAmount\":0,\"minWithdrawToAdmin\":0,\"nicknameSearchUser\":1,\"nodesInfoList\":[],\"pCXMPPDomain\":\"api.jiagongchang.cc\",\"pCXMPPHost\":\"api.jiagongchang.cc\",\"pcAppUrl\":\"\",\"pcDisable\":\"\",\"pcExplain\":\"\",\"pcVersion\":0,\"popularAPP\":\"{\\\"lifeCircle\\\":1,\\\"videoMeeting\\\":1,\\\"liveVideo\\\":1,\\\"shortVideo\\\":1,\\\"peopleNearby\\\":1,\\\"scan\\\":1}\",\"projectIco\":\"\",\"projectLogo\":\"\",\"projectName\":\"家工厂IM\",\"qqLoginStatus\":2,\"regeditPhoneOrName\":1,\"registerInviteCode\":0,\"shareUrl\":\"\",\"showContactsUser\":0,\"softUrl\":\"\",\"tabBarConfigList\":{\"tabBarNum\":0,\"tabBarStatus\":0},\"tlPayStatus\":2,\"tlWithdrawStatus\":2,\"transferRate\":0,\"uploadMaxSize\":20,\"uploadUrl\":\"http://api.jiagongchang.cc:8088/\",\"videoLen\":\"20\",\"webDownloadUrl\":\"\",\"webNewUrl\":\"\",\"website\":\"\",\"wechatH5LoginStatus\":2,\"wechatLoginStatus\":2,\"wechatPayStatus\":2,\"wechatWithdrawStatus\":2,\"weiBaoMaxRedPacketAmount\":0,\"weiBaoMaxTransferAmount\":0,\"weiBaoMinTransferAmount\":0,\"weiBaoTransferRate\":0,\"weiPayStatus\":2,\"weiWithdrawStatus\":2,\"xMPPDomain\":\"im.jiagongchang.cc\",\"xMPPHost\":\"im.jiagongchang.cc\",\"xMPPTimeout\":180,\"xmppPingTime\":72,\"yunPayStatus\":2,\"yunWithdrawStatus\":2},\"resultCode\":1}";
...
-(void)getDefaultValue{ 
     ...
     NSString* defApiUrl = @"http://api.jiagongchang.cc:8092/config";//otherSK
    
//        defApiUrl = @"http://xxxxx:8092/config";//otherSK
//        defApiUrl = @"http://103.145.107.68:8092/config";//otherSK
