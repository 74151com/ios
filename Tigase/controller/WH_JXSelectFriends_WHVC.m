...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if ( _tranfer==YES) {
        ...
        if(self.delegate != nil && [self.delegate respondsToSelector:_didSelect])
            [self.delegate performSelectorOnMainThread:_didSelect withObject:member waitUntilDone:YES];
