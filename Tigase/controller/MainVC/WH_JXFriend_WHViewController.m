...
//        self.title = Localized(@"WaHu_JXInput_WHVC_Friend");
        ...
        _table.backgroundColor =RGB(233, 233, 233);//  g_factory.globalBgColor;
...
- (void)showNewMsgCount:(NSInteger)friendNewMsgNum {
    ...
    NSMutableArray *abUreadf =  [[WH_JXFriendObject sharedInstance] seleectNewMsgUserId:MY_USER_ID];
    if(abUread.count==0){
       // abUread = abUreadf;
    }
...
//    }
    ...
    NSArray *buttonInfoArray = @[@{@"title":@"新的朋友",@"image":@"新朋youCha"},
