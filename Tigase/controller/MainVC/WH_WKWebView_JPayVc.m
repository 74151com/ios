...
#import "WH_WKWebView_JPayVc.h"

#import "NSString+RITLExtension.h"

@interface WH_WKWebView_JPayVc ()

@end

@implementation WH_WKWebView_JPayVc
...
- (void)webViewLoad {
    ...
    self.wkWebView = [[WKWebView  alloc] initWithFrame:CGRectMake(0, JX_SCREEN_TOP + 3, JX_SCREEN_WIDTH, CGRectGetHeight(self.view.frame) - JX_SCREEN_TOP - 3)];
