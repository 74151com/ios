...
//    [g_server getAgoraInfo:self fileName:self.meetUrl];
...
- (void) customView {
    ...
    [g_server WH_getHeadImageLargeWithUserId:self.toUserId userName:self.toUserName imageView:_headerImage];// getHeadImageLarge:self.toUserId imageView:_headerImage];
...
-(void) WH_didServerResult_WHSucces:(WH_JXConnection*)aDownload dict:(NSDictionary*)dict array:(NSArray*)array1{
    ...
    [_player wh_stop];
    _player = nil;
    [g_notify postNotificationName:@"modelarg" object:_model];
    
    [g_default setObject:dict forKey:@"currentModel"];
