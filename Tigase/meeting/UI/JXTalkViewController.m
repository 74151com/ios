...
- (void)customView {
    ...
    [self.wh_tableBody addSubview:backImageView];
    ...
    [self.wh_tableBody addSubview:close];
...
//            [g_server getHeadImageLarge:g_myself.userId userName:g_myself.userNickname imageView:_headImage];
            ...
            [g_server WH_getHeadImageLargeWithUserId:g_myself.userId userName:g_myself.userNickname imageView:_headImage];
...
- (void)sendOnlineMsg:(WH_JXMessageObject *)msg1 {
    ...
    if ([msg.type intValue] == kWCMessageTypeAudioMeetingSetSpeaker) {
        if (!self.isSpeak) {
            ...
            dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
                ...
                [g_server WH_getHeadImageLargeWithUserId:msg.fromUserId userName:msg.fromUserName imageView:_headImage];
                _name.hidden = YES;
                _freeIcon.hidden = YES;
                _idleImageView.image = nil;
                _aniImageView.hidden = NO;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [g_server WH_getHeadImageLargeWithUserId:model.userId userName:model.userName imageView:self.talkView.headImageView ];
